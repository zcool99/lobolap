...
class CollaboratorsControllerTest < ActionController::TestCase
  ...
  test "should create collaborator" do
    assert_difference('Collaborator.count') do
      post :create, collaborator: { apellidos: @collaborator.apellidos, carrera: @collaborator.carrera, matricula: @collaborator.matricula, nombre: @collaborator.nombre, statu: @collaborator.statu }
    end
  ...
  test "should update collaborator" do
    patch :update, id: @collaborator, collaborator: { apellidos: @collaborator.apellidos, carrera: @collaborator.carrera, matricula: @collaborator.matricula, nombre: @collaborator.nombre, statu: @collaborator.statu }
    assert_redirected_to collaborator_path(assigns(:collaborator))
  end
